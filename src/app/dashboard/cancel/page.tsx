      ...
      <section className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-white">
              Review cancellation eligibility
            </h2>
          </div>
          <Link
        ...
        {booking ? (
          <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              <div className="space-y-5">
                ...
                {booking.canCancel ? (
                  <div className="rounded-[1.35rem] border border-emerald-500/20 bg-emerald-500/10 p-4">
                    <p className="text-sm font-semibold text-emerald-200">
                      This booking is eligible for cancellation under policy.
                    </p>
                    <p className="mt-2 text-sm leading-7 text-emerald-100/80">
                      {booking.policy.refundPercentage === 100
                        ? "Full refund placeholder applies, and the slot will reopen immediately after cancellation."
                        : `${booking.policy.refundPercentage}% refund placeholder applies, and the slot will reopen immediately after cancellation.`}
                    </p>
                  </div>
                ) : (
                ...
                {booking.canCancel ? (
                  <form action={cancelDashboardBookingAction} className="rounded-[1.35rem] border border-white/8 bg-white/[0.03] p-4">
          ...
          <DashboardEmptyState
            ...
            description="Select one of your confirmed bookings from the bookings page to see the cancellation policy and the request options."
