...
const galleryImages = [
  {
    src: "/the-arcade/dsc02541.webp",
    width: 7008,
    height: 4672,
    alt: "The Arcade lounge seating",
  },
  {
    src: "/the-arcade/dsc02546.webp",
    width: 7008,
    height: 4672,
    alt: "The Arcade hall interior",
  },
  {
    src: "/the-arcade/dsc02547.webp",
    width: 7008,
    height: 4672,
    alt: "The Arcade entry corridor",
  },
  {
    src: "/the-arcade/dsc02552.webp",
    width: 4096,
    height: 3072,
    alt: "The Arcade event setup",
  },
  {
    src: "/the-arcade/dsc02553.webp",
    width: 4096,
    height: 3072,
    alt: "The Arcade guest-facing view",
  },
  {
    src: "/the-arcade/dsc02557.webp",
    width: 4096,
    height: 3072,
    alt: "The Arcade premium ambience",
  },
  {
    src: "/verve-studio/DSC02505 (1).webp",
    width: 7008,
    height: 3072,
    alt: "Verve Studio wide room view",
  },
  {
    src: "/verve-studio/dsc02518.webp",
    width: 4096,
    height: 3072,
    alt: "Verve Studio recording setup",
  },
  {
    src: "/verve-studio/DSC02464.webp",
    width: 4096,
    height: 3072,
    alt: "Verve Studio premium interview corner",
  },
  {
    src: "/verve-studio/DSC02469 (1).webp",
    width: 4096,
    height: 3072,
    alt: "Verve Studio accent backdrop",
  },
  {
    src: "/verve-studio/DSC02496.webp",
    width: 7008,
    height: 3072,
...
export function ArcGalleryHeroDemo() {
  return (
    <ArcGalleryHero
      ...
      className="mt-12 min-h-[30rem] w-full bg-black pb-4 text-white sm:mt-16 sm:min-h-[36rem] md:mt-20 md:pb-0"
      startAngle={16}
      endAngle={164}
      radiusLg={500}
      radiusMd={360}
